...
How to Use the App
Enter a country name in the input box and click "Submit."

Wait for the dropdown menu to appear, then select a city.

Sit back and watch as graphs displaying the top-rated hostels are generated.
